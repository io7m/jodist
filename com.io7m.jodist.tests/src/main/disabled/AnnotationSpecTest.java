...
public final class AnnotationSpecTest {
  ...
  @Test public void defaultAnnotation() {
    ...
    assertThat(toString(taco)).isEqualTo(""
        ...
        + "\n"
        + "import com.io7m.jodist.AnnotationSpecTest;\n"
  ...
  @Test public void defaultAnnotationWithImport() {
    ...
    JavaFile file = JavaFile.builder("com.io7m.jodist.tests", typeBuilder.build()).build();
  ...
  @Test public void emptyArray() {
    ...
    assertThat(builder.build().toString()).isEqualTo(
        "@com.io7m.jodist.AnnotationSpecTest.HasDefaultsAnnotation(" + "n = {}" + ")");
    builder.addMember("m", "$L", "{}");
    assertThat(builder.build().toString())
        .isEqualTo(
            "@com.io7m.jodist.AnnotationSpecTest.HasDefaultsAnnotation("
                + "n = {}, m = {}"
                + ")");
  }
  ...
  @Test public void dynamicArrayOfEnumConstants() {
    ...
    assertThat(builder.build().toString()).isEqualTo(
        "@com.io7m.jodist.AnnotationSpecTest.HasDefaultsAnnotation("
            + "n = com.io7m.jodist.AnnotationSpecTest.Breakfast.PANCAKES"
            + ")");
    ...
    assertThat(builder.build().toString()).isEqualTo(
        "@com.io7m.jodist.AnnotationSpecTest.HasDefaultsAnnotation("
            + "n = {"
            + "com.io7m.jodist.AnnotationSpecTest.Breakfast.PANCAKES"
            + ", com.io7m.jodist.AnnotationSpecTest.Breakfast.WAFFLES"
            + ", com.io7m.jodist.AnnotationSpecTest.Breakfast.PANCAKES"
            + "})");
  ...
  @Test public void defaultAnnotationToBuilder() {
    ...
    assertThat(builder.build().toString()).isEqualTo(
        "@com.io7m.jodist.AnnotationSpecTest.HasDefaultsAnnotation("
            + "o = com.io7m.jodist.AnnotationSpecTest.Breakfast.PANCAKES"
            + ", p = 1701"
            + ", f = 11.1"
            + ", m = {9, 8, 1, 123}"
            + ", l = java.lang.Override.class"
            + ", j = @com.io7m.jodist.AnnotationSpecTest.AnnotationA"
            + ", q = @com.io7m.jodist.AnnotationSpecTest.AnnotationC(\"bar\")"
