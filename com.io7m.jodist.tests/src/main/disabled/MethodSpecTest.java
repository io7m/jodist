...
import static com.io7m.jodist.tests.TestUtil.findFirst;
...
public final class MethodSpecTest {
  ...
  @Test public void overrideFinalClassMethod() {
    ...
    try {
      ...
      assertThat(expected).hasMessageThat().isEqualTo(
          "Cannot override method on final class com.io7m.jodist.MethodSpecTest.FinalClass");
    }
  }
  ...
  @Test public void overrideDoesNotCopyParameterAnnotations() {
    ...
    ClassName implClassName = ClassName.get("com.io7m.jodist", "Impl");
