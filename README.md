...
| JVM | Platform | Status |
|-----|----------|--------|
| OpenJDK (Temurin) Current | Linux | [![Build (OpenJDK (Temurin) Current, Linux)](https://img.shields.io/github/workflow/status/io7m/jodist/main.linux.temurin.current)](https://github.com/io7m/jodist/actions?query=workflow%3Amain.linux.temurin.current)|
